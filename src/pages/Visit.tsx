              ...
              <ScrollReveal key={loc.title} delay={i * 80}>
                <div className="flex gap-5">
                  ...
                  <div className="flex-1">
                    <p className="font-serif text-2xl font-light text-stone-900 mb-6">{loc.title}</p>

                    {/* Address */}
                    <div className="mb-5">
                      <p className="text-[10px] font-sans tracking-[0.2em] uppercase text-stone-400 mb-2">{v.address.label}</p>
                    ...
                    {/* Hours */}
                    <div className="mb-5">
                      <p className="text-[10px] font-sans tracking-[0.2em] uppercase text-stone-400 mb-2">{t.footer.hours.label}</p>
